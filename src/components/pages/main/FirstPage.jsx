            ...
            <div className={styles.firstContainer}>
                <div>
                    ...
                    <div className={styles.imageDiv}>
                        <img ref={el => imagesRef.current[1] = el} className={`${styles.appImage} ${styles.appImage1}`} src="/img/Main.png" alt="앱 메인페이지 사진" />
                        <img ref={el => imagesRef.current[2] = el} className={`${styles.appImage} ${styles.appImage2}`} src="/img/MBTI.png" alt="피부 MBTI 검사 페이지 사진" />
                    </div>
                    <p className={styles.bannerSmallText}>스킨버디는 간편하고 신뢰성 있는 방식으로 사용자의 피부 건강증진을 돕습니다</p>
                </div>
                <div className={styles.pageContainer}>
                    <div className={styles.imageDiv}>
                        <img ref={el => imagesRef.current[3] = el} className={`${styles.appImage} ${styles.appImage1}`} src="/img/Classification.png" alt="유형 분석 페이지 사진" />
                        <img ref={el => imagesRef.current[4] = el} className={`${styles.appImage} ${styles.appImage2}`} src="/img/ClassificationHistory.png" alt="유형 분석 진단 기록 사진" />
                        <img ref={el => imagesRef.current[5] = el} className={`${styles.appImage} ${styles.appImage3}`} src="/img/Detection.png" alt="호전도 분석 페이지 사진" />
                        <img ref={el => imagesRef.current[6] = el} className={`${styles.appImage} ${styles.appImage4}`} src="/img/DetectionHistory.png" alt="호전도 분석 진단 기록 사진" />
                    </div>
